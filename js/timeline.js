...
function initScrollAnimations() {
  ...
  controller.pin($('#scene1'), 19500, {
                  anim: (new TimelineLite())
				  	.append(
                   TweenMax.from($('#welcome'), 0.7, 
                   ...
                   TweenMax.fromTo($('#move-fore'), 1.1, 
					...
					.append(
                   TweenMax.fromTo($('#move-backg'), 1.45, 
                                    {css:{bottom: -210}, immediateRender:true}, 
                                    {css:{bottom: -850}}),
									-1.1
					)
					.append(
                   ...
                   TweenMax.fromTo($('#fling-it-right'), 1, 
                                    ...
                                    {css:{left:160, top: 390, scaleX: 2.7, scaleY: 2.7}})	
                   )
                   .append(
                   TweenMax.fromTo($('#fling-it'), 1, 
                                    {css:{left:100, top: 20, scaleX: 1, scaleY: 1}, immediateRender:true}, 
                                    {css:{left:640, top: 5, scaleX: 0.4, scaleY: 0.4}}),
									-1		
                   )
				   .append(
